  ...
  cropsToRender.forEach(crop => {
    ...
    card.innerHTML = `
      <div class="card-content" style="padding: 16px;">
        <div class="mc-header">
          <div class="mc-info">
            <div class="mc-name">${cropName(crop)}</div>
        ...
        <div class="mc-prices">
          <div class="mc-today">
            ...
            <div class="mc-price-val">₹${crop.todayPrice.toLocaleString()}<span class="mc-price-unit">${t('per_qtl')}</span></div>
          </div>
          <div class="mc-yesterday">
            <div class="mc-price-label">${t('past_price')} (${yStr})</div>
            <div class="mc-price-val muted">₹${crop.yesterdayPrice.toLocaleString()}<span class="mc-price-unit">${t('per_qtl')}</span></div>
          </div>
        </div>
