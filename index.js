...
async function initLiveDataWidgets() {
  ...
  try {
    // Open-Meteo Free API (Nagpur Central India coordinates used as aggregate)
    const res = await fetch("https://api.open-meteo.com/v1/forecast?latitude=21.14&longitude=79.08&current=temperature_2m,precipitation&timezone=Asia%2FKolkata");
    ...
    document.getElementById("weatherWidget").innerHTML = `
      ...
      <div>
        <div class="live-widget-title">${t('central_india_weather')}</div>
